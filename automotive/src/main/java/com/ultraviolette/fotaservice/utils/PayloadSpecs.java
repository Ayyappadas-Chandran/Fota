...
public class PayloadSpecs {
    private static final String TAG = "PayloadSpecs";
    public PayloadSpecs() {}
    ...
    public PayloadSpec forNonStreaming(File packageFile) throws IOException {
        Log.e(TAG, "PayloadSpec forNonStreaming");
        ...
        try (ZipFile zip = new ZipFile(packageFile)) {
            ...
            while (entries.hasMoreElements()) {
                Log.e(TAG, "PayloadSpec hasMoreElements");
                ...
                if (PackageFiles.PAYLOAD_BINARY_FILE_NAME.equals(name)) {
                    Log.e(TAG, "PayloadSpec exists for " + PackageFiles.PAYLOAD_BINARY_FILE_NAME);
                    ...
                    Log.e(TAG, "PayloadSpec exists for " + PackageFiles.PAYLOAD_PROPERTIES_FILE_NAME);
